...
(defclass account-entry (accounting-entry posting)
  (
   )
  )
(defclass journal ()
  (
   ...
   (batches :accessor batches :initform (make-list 0))
   )
  )
(defclass batch (posting)
  (
   (entries :accessor entries :initform (make-list 0))
   )
  )
(defclass batch-entry (accounting-entry)
  (
